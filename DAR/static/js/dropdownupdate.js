document.addEventListener('DOMContentLoaded',function(){
    ...
    // console.log(x)
    // let distdropwon =document.getElementById('neighborhoodSelect');
    ...
    let c= document.getElementById('citySelect');
    let cityvalue =document.getElementById('citySelect').value;
    console.log(cityvalue);
    populatecity().then(() => {c.value = cityvalue;});
    let d =document.getElementById('neighborhoodSelect');
    let distvalue = document.getElementById('neighborhoodSelect').value;
